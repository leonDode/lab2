#!/usr/bin/env python3
"""
Lab 2 - Método de Wegstein
Estudante 3: Implementação do método de Wegstein com aceleração

Este módulo implementa o método de Wegstein para encontrar raízes de equações não lineares.
"""
...
def solve_problema_a() -> Dict[str, RootResult]:
    """Resolve o Problema A com Wegstein."""
    print("\n" + "="*60)
    print("PROBLEMA A: f(x) = exp(-x) - 2*sqrt(x)")
    print("Método: Wegstein")
    print("="*60)
    
    results = {}
    
    # Wegstein com g1
    print("\nExecutando Wegstein (g1)...")
...
def solve_problema_b() -> Dict[str, RootResult]:
    """Resolve o Problema B com Wegstein."""
    print("\n" + "="*60)
...
def print_summary(results_a: Dict[str, RootResult], results_b: Dict[str, RootResult]):
    ...
    print("\n" + "="*60)
    print("RESUMO COMPARATIVO - WEGSTEIN")
    print("="*60)
    ...
    print("- Salvaguardas previnem explosões numéricas")
    print("- Backtracking evita degradação do residual")
    print("- Projeção de domínio mantém variáveis em regiões válidas")
